 ...
 */
class _latestCollabs extends \IPS\Widget\PermissionCache
{
	/**
	 * @brief	Widget Key
	 */
	public $key = 'latestCollabs';
	...
	{
		$collabs = \IPS\collab\Collab::getItemsWithPermission( array(), NULL, isset( $this->configuration[ 'number_to_show' ] ) ? $this->configuration[ 'number_to_show' ] : 5 );
		if ( count( $collabs ) )
		{
